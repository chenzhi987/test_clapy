...
const VuesaxBoldGalleryIcon3 = (props: SVGProps<SVGSVGElement>) => (
  <svg preserveAspectRatio='none' viewBox='0 0 60 60' fill='none' xmlns='http://www.w3.org/2000/svg' {...props}>
    <path
      d='M6.45 47.525L6.4 47.575C5.725 46.1 5.3 44.425 5.125 42.575C5.3 44.4 5.775 46.05 6.45 47.525Z'
      fill='#15CFAC'
    />
    <path
      d='M22.5 25.95C25.7861 25.95 28.45 23.2861 28.45 20C28.45 16.7139 25.7861 14.05 22.5 14.05C19.2139 14.05 16.55 16.7139 16.55 20C16.55 23.2861 19.2139 25.95 22.5 25.95Z'
      fill='#15CFAC'
    />
    <path
...
const Memo = memo(VuesaxBoldGalleryIcon3);
export { Memo as VuesaxBoldGalleryIcon3 };
