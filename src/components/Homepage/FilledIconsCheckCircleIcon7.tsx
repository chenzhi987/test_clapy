...
const FilledIconsCheckCircleIcon7 = (props: SVGProps<SVGSVGElement>) => (
  <svg preserveAspectRatio='none' viewBox='0 0 16 16' fill='none' xmlns='http://www.w3.org/2000/svg' {...props}>
    <g clipPath='url(#clip0_194_924)'>
      <path
...
const Memo = memo(FilledIconsCheckCircleIcon7);
export { Memo as FilledIconsCheckCircleIcon7 };
